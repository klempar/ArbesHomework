...
public class ArbesTelephoneBillCalculatorTest {
    ...
    @Test
    public void calculate_testFromDocumentation() throws IOException, ParseException {
        String inputCSV =
    ...
    @Test
    public void calculate_testOkInput_moreRows() throws IOException, ParseException {
    ...
    @Test
    public void calculate_okInput_A() throws IOException, ParseException {
        String inputCSV =
    ...
    @Test
    public void calculate_testOneNumberInput() throws IOException, ParseException {
        String inputCSV =
                "420774577453,13-01-2020 18:10:15,13-01-2020 18:12:57\n";
    ...
    @Test
    public void calculate_testEndedTheSameTime() throws IOException, ParseException {
    ...
    @Test
    public void calculate_invalidNumberA() throws IOException, ParseException {
        String inputCSV =  "a1b3,13-01-2020 18:10:15,13-01-2020 18:12:57\n";
        calculator.calculate(inputCSV);

    }
    @Test
    public void calculate_invalidNumberB() throws IOException, ParseException {
    ...
    @Test
    public void calculate_invalidInputDate_A() throws IOException, ParseException {
    ...
    @Test
    public void calculate_invalidInputDate_B() throws IOException, ParseException {
        String inputCSV = "420774577453,13-01-2020 07:50:00,13-01-2020 08:15:00\n" +
    ...
    @Test
    public void calculate_invalidInput_endBeforeStart() throws IOException, ParseException {
        String inputCSV = "420774577453,13-01-2020 07:50:00,13-01-2020 08:15:00\n" +
                "420774577454,13-01-2020 08:10:00,13-01-2020 08:15:00\n" +
                "420774577455,13-01-2020 09-00-2020 09:00:00,13-01-2020 09:30:00\n" +  // Špatný formát data
                "420774577456,13-01-2020 10:00:00,13-01-2020 10:45:00\n" +
    ...
    @Test
    public void calculate_invalidNumberOfParameters() throws IOException, ParseException {
        String inputCSV = "420774577453,13-01-2020 07:50:00,13-01-2020 08:15:00\n" +
